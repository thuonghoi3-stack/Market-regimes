 ...
 *
 * `GROK_PREVIEW_CLIENT_ID` / `GROK_PREVIEW_CLIENT_SECRET` are configured on the
 * broker. Supply the latter through the app environment; never commit it. This
 * remains a dedicated, low-privilege preview client for `*.grok-sandbox.com`.
 */
